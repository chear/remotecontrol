...
import com.zkar.outside.util.ShellUtils.CommandResult;
...
public class PackageUtils {
	...
	public static int installSilent(Context context, String filePath,
		...
		String chmodCommand = "chmod 777 " + rawFilePath + " \n";

		StringBuilder command = new StringBuilder()
				.append("LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install ")
				.append(pmParams == null ? "" : pmParams).append(" ")
				.append(rawFilePath);
		CommandResult commandResult = ShellUtils.execCommand(new String[] {
				chmodCommand, command.toString() },
